            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="index.php">Ubah Buku</a>
                    </div>
                                ...
                                <form action="update_borrow.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="member" name="member" class="form-control" required>
                                            <?php while ($row = $memberResult->fetch_object()) { ?>
                                                <option <?php echo ($row->id == $old->member_id) ? 'selected' : '' ?> value="<?php echo $row->id ?>"><?php echo $row->name ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select id="book" name="book" class="form-control" required>
                                            <?php while ($row = $bookResult->fetch_object()) { ?>
                                                <option <?php echo ($row->id == $old->book_id) ? 'selected' : '' ?> value="<?php echo $row->id ?>"><?php echo $row->title ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="start_date">Tanggal Pinjam</label>
                                        <input type="date" class="form-control" id="start_date" name="start_date" value="<?php echo $old->start_date ?>" required>
                                    </div>
